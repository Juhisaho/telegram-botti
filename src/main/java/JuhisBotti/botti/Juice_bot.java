...
public class Juice_bot extends TelegramLongPollingBot {
	...
	private String piraatti = EmojiParser.parseToUnicode(":gorilla:");
	private String heilutus = EmojiParser.parseToUnicode(":wave:");
	private String avain = EmojiParser.parseToUnicode(":key:");
	...
	public void onUpdateReceived(Update update) {
		...
		if (command.equals("/start")) {
			message.setText(
					"Tervetuloa käyttämään Juhiksen bottia!" + heilutus + "\nLisätietoa komennolla /help !" + avain);
		}
		if (command.equals("/tekija"))

		{
			message.setText("Botti on Juhiksen käsialaa!" + piraatti);
		}
